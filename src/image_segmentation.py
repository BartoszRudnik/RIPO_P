...
def average_slope_intercept(image, lines):
    ...
    left_detected, left_line = make_coordinates(image, left_fit_average)

    right_fit_average = np.average(right_fit, axis=0)
    right_detected, right_line = make_coordinates(image, right_fit_average)
...
def analize_video(frame):
    ...
    valid_detection, average_lines_image = average_slope_intercept(frame, hough_image)
